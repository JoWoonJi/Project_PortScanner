### 24/1/31 ~24/2/1 프로젝트 블루프린트. 로우레벨로 포트별 포트스캐너. py. 리눅스 기반 구현 -> gui시도 or 플라스크   // 열려있는 포트에 대한 정보를 알려주는 포트스캐너 , 역으로 모의해킹용 포트스캐너?
...
### 2/9 ~ 12 설 연휴 
### 2/13 ~ 14 gui or 플라스크 구현 시도, 오류잡기 // flask로 방향잡고 통합해서 구동완료.
