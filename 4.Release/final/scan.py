...
def scan_https_port(host, port=443, timeout=5):
    response_data = {'service': 'HTTPS', 'port': port, 'state': 'open', 'banner': None}
...
def scan_dns_port(host, timeout=5):
    response_data = {'service': 'DNS', 'port': 53, 'state': 'closed', 'banner': None}
...
def scan_rdp_port(ip, port=3389, timeout=5):
    response_data = {'service': 'RDP', 'port': port, 'state': 'closed', 'error': None}
...
#     response_data = {'service': 'TFTP', 'port': port,  'info': 'unknown'}
...
#     response_data = {'service': 'RPC', 'port': port, 'state': 'closed', 'details': None}
...
#995 jo
# def scan_pop3d_port(host, port=995, timeout=3):
#     response_data = {'service': 'POP3S', 'port': port, 'state': 'closed or filtered', 'banner': None}
...
def scan_smtp_port(host, port=25, timeout=7):
    response_data = {'service': 'SMTP', 'port': port, 'state': 'closed', 'banner': None}
...
def scan_smtp_submission_port(host, port=587, timeout=7):
    response_data = {'service': 'SMTP-Submission', 'port': port, 'state': 'closed', 'banner': None}
